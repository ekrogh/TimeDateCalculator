...
[assembly: Xamarin.Forms.Dependency(typeof(pdfCalcProj.UWP.FileHandlers.HandleFiles_UWP))]
namespace pdfCalcProj.UWP.FileHandlers
{
	class HandleFiles_UWP : IHandleFiles
	{
		...
		public async Task SelectFilesToReadFrom(string[] filetypes)
		{
			try
			{
				...
				// Fire the message
				MessagingCenter.Send((pdfCalcProj.App)Application.Current,
