...
{
	public class myMacOSDatePickerRenderer : ViewRenderer<myMacOSDatePicker, NSDatePicker>
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<myMacOSDatePicker> e)
		{
