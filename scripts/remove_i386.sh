...
# Target _CodesignNativeLibraries:
    /usr/bin/codesign execution started with arguments: -v --force --sign EC1CB5386BE4DBBF9A2766A31366D28745E52AD7 /Users/eks/projects/xamarinProjs/TimeDateCalculator/timeDateCalculator/timeDateCalculator.macOS/bin/Release/timeDateCalculator.macOS.app/timeDateCalculator.macOS.app/Contents/MonoBundle/libMonoPosixHelper.dylib
# Target _CodesignAppBundle:
    /usr/bin/codesign execution started with arguments: -v --force --sign EC1CB5386BE4DBBF9A2766A31366D28745E52AD7 --entitlements /Users/eks/projects/xamarinProjs/TimeDateCalculator/timeDateCalculator/timeDateCalculator.macOS/obj/x64/Release/Entitlements.xcent /Users/eks/projects/xamarinProjs/TimeDateCalculator/timeDateCalculator/timeDateCalculator.macOS/bin/Release/timeDateCalculator.macOS.app/timeDateCalculator.macOS.app
# Target _CodesignVerify:
    ...
    bin/Release/timeDateCalculator.macOS.app/timeDateCalculator.macOS.app: valid on disk
    bin/Release/timeDateCalculator.macOS.app/timeDateCalculator.macOS.app: satisfies its Designated Requirement
